...
namespace LoginSystem.MessageBox
{
    ...
    public static class MetroMessageBox
    {
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText);
            msg.ShowDialog();
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText, caption);
            msg.ShowDialog();
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText, caption, button);
            msg.ShowDialog();
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText, caption, button, icon);
            msg.ShowDialog();
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText, caption, MessageBoxButton.OK)
            {
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText, caption, MessageBoxButton.OK, icon)
            {
                OkButtonText = okButtonText
            };
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText, caption, MessageBoxButton.OKCancel)
            {
                OkButtonText = okButtonText,
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText, caption, MessageBoxButton.OKCancel, icon)
            {
                OkButtonText = okButtonText,
                CancelButtonText = cancelButtonText
            };
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNo)
            {
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNo, icon)
            {
                YesButtonText = yesButtonText,
                NoButtonText = noButtonText
            };
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNoCancel)
            {
                YesButtonText = yesButtonText,
                NoButtonText = noButtonText,
                CancelButtonText = cancelButtonText
        ...
        {
            MetroMessageBoxWindow msg = new MetroMessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNoCancel, icon)
            {
                YesButtonText = yesButtonText,
                NoButtonText = noButtonText,
                CancelButtonText = cancelButtonText
